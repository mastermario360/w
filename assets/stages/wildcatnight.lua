function onCreate()
	...
	if not lowQuality then
		...
		makeLuaSprite('city','wildcatnight/city', 1548, 270)
		...
		makeLuaSprite('quote sand','wildcatnight/quote sand', -747, 423)
	    addLuaSprite('quote sand', false)
	    setLuaSpriteScrollFactor('quote sand', 0.6, 0.6);
	    scaleObject('quote sand', 1, 1);

		makeLuaSprite('quote fences','wildcatnight/quote fences', -750, 370)
	    addLuaSprite('quote fences', false)
	    setLuaSpriteScrollFactor('quote fences', 0.8, 0.8);
	    scaleObject('quote fences', 1, 1);
