...
function onStepHit() -- Idle Function
    ...
    if getProperty('bffl.animation.curAnim.name')  ~= null and curBeat % 1 == 0 and singing ~= 1 then -- avoiding Glitchy animation like Kade Engine LMAO
...
if noteType == 'bffl_Sing' and noteData == 10 then
	
	objectPlayAnimation('bffl', 'singUP',true);
	
end
	
if noteType == 'bffl_Sing' and noteData == 11 then
...
if noteType == '2,4_Sing' and noteData == 0 then
		
	objectPlayAnimation('bffl', 'singLEFT',true);

end

if noteType == '2,4_Sing' and noteData == 1 then

	objectPlayAnimation('bffl', 'singDOWN',true);

end

if noteType == '2,4_Sing' and noteData == 2 then
