...
function onStepHit() -- Idle Function
    ...
    if getProperty('bfrs.animation.curAnim.name')  ~= null and curBeat % 1 == 0 and singing ~= 1 then -- avoiding Glitchy animation like Kade Engine LMAO
...
function goodNoteHit(id, noteData, noteType, isSustainNote) -- I like making easy code so this is different from Catbrother everything code :D
		...
		if noteType == 'bfrs_Sing' and noteData == 10 then
			
			objectPlayAnimation('bfrs', 'singUP',true);
			
		end
			
		if noteType == 'bfrs_Sing' and noteData == 11 then
			
			objectPlayAnimation('bfrs', 'singRIGHT',true);
			
		end
		
		if noteType == 'BOBF4_Sing' and noteData == 0 then
		
			objectPlayAnimation('bfrs', 'singLEFT',true);
			
		end
			
		if noteType == 'BOBF4_Sing' and noteData == 1 then
			
			objectPlayAnimation('bfrs', 'singDOWN',true);
			
		end
			
		if noteType == 'BOBF4_Sing' and noteData == 2 then
			
			objectPlayAnimation('bfrs', 'singUP',true);
			
		end
			
		if noteType == 'BOBF4_Sing' and noteData == 3 then
			
			objectPlayAnimation('bfrs', 'singRIGHT',true);
			
		end
		
		if noteType == 'BOBF4_Sing' and noteData == 4 then
		
			objectPlayAnimation('bfrs', 'singLEFT',true);
			
		end
			
		if noteType == 'BOBF4_Sing' and noteData == 5 then
			
			objectPlayAnimation('bfrs', 'singDOWN',true);
			
		end
			
		if noteType == 'BOBF4_Sing' and noteData == 6 then
			
			objectPlayAnimation('bfrs', 'singUP',true);
			
		end
			
		if noteType == 'BOBF4_Sing' and noteData == 7 then
			
			objectPlayAnimation('bfrs', 'singRIGHT',true);
			
		end
		
		if noteType == 'BOBF4_Sing' and noteData == 8 then
		
			objectPlayAnimation('bfrs', 'singLEFT',true);
			
		end
			
		if noteType == 'BOBF4_Sing' and noteData == 9 then
			
			objectPlayAnimation('bfrs', 'singDOWN',true);
			
		end
			
		if noteType == 'BOBF4_Sing' and noteData == 10 then
			
			objectPlayAnimation('bfrs', 'singUP',true);
			
		end
			
		if noteType == 'BOBF4_Sing' and noteData == 11 then
			
			objectPlayAnimation('bfrs', 'singRIGHT',true);
			
		end
		
		if noteType == 'BOBF5_Sing' and noteData == 0 then
		
			objectPlayAnimation('bfrs', 'singLEFT',true);
			
		end
			
		if noteType == 'BOBF5_Sing' and noteData == 1 then
			
			objectPlayAnimation('bfrs', 'singDOWN',true);
			
		end
			
		if noteType == 'BOBF5_Sing' and noteData == 2 then
			
			objectPlayAnimation('bfrs', 'singUP',true);
			
		end
			
		if noteType == 'BOBF5_Sing' and noteData == 3 then
			
			objectPlayAnimation('bfrs', 'singRIGHT',true);
			
		end
		
		if noteType == 'BOBF5_Sing' and noteData == 4 then
		
			objectPlayAnimation('bfrs', 'singLEFT',true);
			
		end
			
		if noteType == 'BOBF5_Sing' and noteData == 5 then
			
			objectPlayAnimation('bfrs', 'singDOWN',true);
			
		end
			
		if noteType == 'BOBF5_Sing' and noteData == 6 then
			
			objectPlayAnimation('bfrs', 'singUP',true);
			
		end
			
		if noteType == 'BOBF5_Sing' and noteData == 7 then
			
			objectPlayAnimation('bfrs', 'singRIGHT',true);
			
		end
		
		if noteType == 'BOBF5_Sing' and noteData == 8 then
		
			objectPlayAnimation('bfrs', 'singLEFT',true);
			
		end
			
		if noteType == 'BOBF5_Sing' and noteData == 9 then
			
			objectPlayAnimation('bfrs', 'singDOWN',true);
			
		end
			
		if noteType == 'BOBF5_Sing' and noteData == 10 then
			
			objectPlayAnimation('bfrs', 'singUP',true);
			
		end
			
		if noteType == 'BOBF5_Sing' and noteData == 11 then
		...
		if noteType == 'ALLBF_Sing' and noteData == 4 then
		
			objectPlayAnimation('bfrs', 'singLEFT',true);
			
		end
			
		if noteType == 'ALLBF_Sing' and noteData == 5 then
			
			objectPlayAnimation('bfrs', 'singDOWN',true);
			
		end
			
		if noteType == 'ALLBF_Sing' and noteData == 6 then
			
			objectPlayAnimation('bfrs', 'singUP',true);
			
		end
			
		if noteType == 'ALLBF_Sing' and noteData == 7 then
			
			objectPlayAnimation('bfrs', 'singRIGHT',true);
			
		end
		
		if noteType == 'ALLBF_Sing' and noteData == 8 then
		
			objectPlayAnimation('bfrs', 'singLEFT',true);
			
		end
			
		if noteType == 'ALLBF_Sing' and noteData == 9 then
			
			objectPlayAnimation('bfrs', 'singDOWN',true);
			
		end
			
		if noteType == 'ALLBF_Sing' and noteData == 10 then
			
			objectPlayAnimation('bfrs', 'singUP',true);
			
		end
			
		if noteType == 'ALLBF_Sing' and noteData == 11 then
			
			objectPlayAnimation('bfrs', 'singRIGHT',true);
			
		end

		if noteType == '1,2,3,4_Sing' and noteData == 0 then
		
			objectPlayAnimation('bfrs', 'singLEFT',true);
		
		end

		if noteType == '1,2,3,4_Sing' and noteData == 1 then
		
			objectPlayAnimation('bfrs', 'singDOWN',true);
		
		end

		if noteType == '1,2,3,4_Sing' and noteData == 2 then
		
			objectPlayAnimation('bfrs', 'singUP',true);
		
		end

		if noteType == '1,2,3,4_Sing' and noteData == 3 then
		
			objectPlayAnimation('bfrs', 'singRIGHT',true);
		
		end

		if noteType == '0,5_Sing' and noteData == 0 then

			objectPlayAnimation('bfrs', 'singLEFT',true);
		
		end

		if noteType == '0,5_Sing' and noteData == 1 then
		
			objectPlayAnimation('bfrs', 'singDOWN',true);
		
		end

		if noteType == '0,5_Sing' and noteData == 2 then
		
			objectPlayAnimation('bfrs', 'singUP',true);
		
		end

		if noteType == '0,5_Sing' and noteData == 3 then
