...
if noteType == 'bfneo_Sing' and noteData == 10 then

	objectPlayAnimation('bfneo', 'singUP',true);

end

if noteType == 'bfneo_Sing' and noteData == 11 then

	objectPlayAnimation('bfneo', 'singRIGHT',true);

end

if noteType == 'BOBF3_Sing' and noteData == 0 then

	objectPlayAnimation('bfneo', 'singLEFT',true);

end

if noteType == 'BOBF3_Sing' and noteData == 1 then

	objectPlayAnimation('bfneo', 'singDOWN',true);

end

if noteType == 'BOBF3_Sing' and noteData == 2 then

	objectPlayAnimation('bfneo', 'singUP',true);

end

if noteType == 'BOBF3_Sing' and noteData == 3 then

	objectPlayAnimation('bfneo', 'singRIGHT',true);

end

if noteType == 'BOBF3_Sing' and noteData == 4 then

	objectPlayAnimation('bfneo', 'singLEFT',true);

end

if noteType == 'BOBF3_Sing' and noteData == 5 then

	objectPlayAnimation('bfneo', 'singDOWN',true);

end

if noteType == 'BOBF3_Sing' and noteData == 6 then

	objectPlayAnimation('bfneo', 'singUP',true);

end

if noteType == 'BOBF3_Sing' and noteData == 7 then

	objectPlayAnimation('bfneo', 'singRIGHT',true);

end

if noteType == 'BOBF3_Sing' and noteData == 8 then

	objectPlayAnimation('bfneo', 'singLEFT',true);

end

if noteType == 'BOBF3_Sing' and noteData == 9 then

	objectPlayAnimation('bfneo', 'singDOWN',true);

end

if noteType == 'BOBF3_Sing' and noteData == 10 then

	objectPlayAnimation('bfneo', 'singUP',true);

end

if noteType == 'BOBF3_Sing' and noteData == 11 then
...
if noteType == 'ALLBF_Sing' and noteData == 11 then
    ...
    if altAnim == true then
		if noteType == '2,3_Sing' and noteData == 0 then
		
			objectPlayAnimation('bfneo', 'singLEFT',true);
		
		end

		if noteType == '2,3_Sing' and noteData == 1 then
		
			objectPlayAnimation('bfneo', 'singDOWN',true);
		
		end

		if noteType == '2,3_Sing' and noteData == 2 then
		...
		if noteType == '1,2_Sing' and noteData == 0 then
		
			objectPlayAnimation('bfneo', 'singLEFT',true);
		
		end

		if noteType == '1,2_Sing' and noteData == 1 then
		
			objectPlayAnimation('bfneo', 'singDOWN',true);
		
		end

		if noteType == '1,2_Sing' and noteData == 2 then
		
			objectPlayAnimation('bfneo', 'singUP',true);
		
		end

		if noteType == '1,2_Sing' and noteData == 3 then
