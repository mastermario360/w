...
-- CUSTOM SPRITE
makeAnimatedLuaSprite('bfplayer', 'characters/gametoonsbf', 0, 0)
...
function onStepHit() -- Idle Function
    ...
    if getProperty('bfplayer.animation.curAnim.name')  ~= null and curBeat % 1 == 0 and singing ~= 1 then -- avoiding Glitchy animation like Kade Engine LMAO
...
if noteType == 'bfplayer_Sing' and noteData == 10 then

	objectPlayAnimation('bfplayer', 'singUP',true);

end

if noteType == 'bfplayer_Sing' and noteData == 11 then
...
if noteType == 'BO03_Sing' and noteData == 0 then

	objectPlayAnimation('bfplayer', 'singLEFT',true);

end

if noteType == 'BO03_Sing' and noteData == 1 then

	objectPlayAnimation('bfplayer', 'singDOWN',true);

end

if noteType == 'BO03_Sing' and noteData == 2 then

	objectPlayAnimation('bfplayer', 'singUP',true);

end

if noteType == 'BO03_Sing' and noteData == 3 then
