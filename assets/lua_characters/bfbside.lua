...
function goodNoteHit(id, noteData, noteType, isSustainNote) -- I like making easy code so this is different from Catbrother everything code :D
	...
	if noteType == 'bfbside_Sing' and noteData == 10 then
	
		objectPlayAnimation('bfbside', 'singUP',true);
	
	end
	
	if noteType == 'bfbside_Sing' and noteData == 11 then
	
		objectPlayAnimation('bfbside', 'singRIGHT',true);
	
	end

if noteType == 'BOBF1_Sing' and noteData == 0 then

	objectPlayAnimation('bfbside', 'singLEFT',true);

end

if noteType == 'BOBF1_Sing' and noteData == 1 then

	objectPlayAnimation('bfbside', 'singDOWN',true);

end

if noteType == 'BOBF1_Sing' and noteData == 2 then

	objectPlayAnimation('bfbside', 'singUP',true);

end

if noteType == 'BOBF1_Sing' and noteData == 3 then

	objectPlayAnimation('bfbside', 'singRIGHT',true);

end

if noteType == 'BOBF1_Sing' and noteData == 4 then

	objectPlayAnimation('bfbside', 'singLEFT',true);

end

if noteType == 'BOBF1_Sing' and noteData == 5 then

	objectPlayAnimation('bfbside', 'singDOWN',true);

end

if noteType == 'BOBF1_Sing' and noteData == 6 then

	objectPlayAnimation('bfbside', 'singUP',true);

end

if noteType == 'BOBF1_Sing' and noteData == 7 then

	objectPlayAnimation('bfbside', 'singRIGHT',true);

end

if noteType == 'BOBF1_Sing' and noteData == 8 then

	objectPlayAnimation('bfbside', 'singLEFT',true);

end

if noteType == 'BOBF1_Sing' and noteData == 9 then

	objectPlayAnimation('bfbside', 'singDOWN',true);

end

if noteType == 'BOBF1_Sing' and noteData == 10 then

	objectPlayAnimation('bfbside', 'singUP',true);

end

if noteType == 'BOBF1_Sing' and noteData == 11 then
