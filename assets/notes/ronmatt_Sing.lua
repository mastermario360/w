function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if not getPropertyFromGroup('unspawnNotes', i, 'mustPress') and getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'ronmatt_Sing' then --Check if the note on the chart is a Bullet Note
